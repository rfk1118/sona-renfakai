import{_ as e,V as p,W as t,X as n,a0 as s,Y as o,$ as c,F as l}from"./framework-fd210779.js";const i={},u=c(`<h1 id="spring-flyweight-policy" tabindex="-1"><a class="header-anchor" href="#spring-flyweight-policy" aria-hidden="true">#</a> spring-flyweight-policy</h1><h3 id="问题" tabindex="-1"><a class="header-anchor" href="#问题" aria-hidden="true">#</a> 问题</h3><p>本章使用 Spring 的容器管理 Service，在处理业务时候根据映射进行转换，从 ApplicationContext 中获取到策略，极大减少了手动编写代码管理 Bean 的问题。 来看一下目录:</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token punctuation">.</span>

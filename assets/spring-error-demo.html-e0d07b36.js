import{_ as e,V as t,W as l,Y as n,a1 as s,Z as p,a0 as i,F as o}from"./framework-1bd9c91b.js";const c={},u=i(`<h1 id="spring-error-demo" tabindex="-1"><a class="header-anchor" href="#spring-error-demo" aria-hidden="true">#</a> spring-error-demo</h1><h3 id="问题" tabindex="-1"><a class="header-anchor" href="#问题" aria-hidden="true">#</a> 问题</h3><p>我们是否中了 Spring 的毒，代码编程模式变成了 <code>Controller -&gt; Service -&gt; Dao</code> (1:1:1)编写。 贫血模型案例代码布局如下:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">.</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>但是我们发现好像问题没有解决，只是把 Service 问题转移到了 Controller，添加一个策略我们都需要添加一个控制器，无法根据数据进行动态选择策略。 下一章我们将用策略(多态)+享元模式解决这个问题。</p>`,23),r={id:"github-地址",tabindex:"-1"},d=n("a",{class:"header-anchor",href:"#github-地址","aria-hidden":"true"},"#",-1),v={href:"https://github.com/sona0402/Polymorphism",target:"_blank",rel:"noopener noreferrer"};function k(m,b){const a=o("ExternalLinkIcon");return t(),l("div",null,[u,n("h3",r,[d,s(),n("a",v,[s("Github 地址"),p(a)])])])}const h=e(c,[["render",k],["__file","spring-error-demo.html.vue"]]);export{h as default};

import{_ as e,V as t,W as l,X as n,a0 as s,Y as p,$ as i,F as o}from"./framework-fd210779.js";const c={},u=i(`<h1 id="spring-error-demo" tabindex="-1"><a class="header-anchor" href="#spring-error-demo" aria-hidden="true">#</a> spring-error-demo</h1><h3 id="问题" tabindex="-1"><a class="header-anchor" href="#问题" aria-hidden="true">#</a> 问题</h3><p>我们是否中了 Spring 的毒，代码编程模式变成了 <code>Controller -&gt; Service -&gt; Dao</code> (1:1:1)编写。 贫血模型案例代码布局如下:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">.</span>

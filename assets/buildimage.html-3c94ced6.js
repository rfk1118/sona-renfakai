import{_ as e,V as i,W as a,a0 as n}from"./framework-1bd9c91b.js";const d="/assets/docker-down-java-99c6761e.png",s="/assets/spring-boot-run-29df1a61.png",l="/assets/docker-mvn-down-6c1ea1ff.png",r="/assets/docker-build-fail-7d114e5b.png",t={},c=n(`<h1 id="build-image" tabindex="-1"><a class="header-anchor" href="#build-image" aria-hidden="true">#</a> Build image</h1><h2 id="准备" tabindex="-1"><a class="header-anchor" href="#准备" aria-hidden="true">#</a> 准备</h2><p>学习docker基本概念、dockerfile语法和机器上启动了BuildKit。</p><h2 id="概述" tabindex="-1"><a class="header-anchor" href="#概述" aria-hidden="true">#</a> 概述</h2><p>要部署一个java项目，需要java二进制文件、需要的依赖、系统文件等。</p><ol><li>docker，打包使用。</li><li>Git客户端，拉取代码使用。</li><li>文本编译器，编写代码使用。</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>// 这里是你要保存项目的文件夹

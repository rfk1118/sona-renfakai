import{_ as n,V as s,W as a,a0 as e}from"./framework-1bd9c91b.js";const t={},p=e(`<h1 id="decorator-netty" tabindex="-1"><a class="header-anchor" href="#decorator-netty" aria-hidden="true">#</a> Decorator-Netty</h1><h3 id="netty-数据优化" tabindex="-1"><a class="header-anchor" href="#netty-数据优化" aria-hidden="true">#</a> netty 数据优化</h3><ol><li><code>SelectedSelectionKeySet</code>代码不在粘贴，其中大部分代码都没有修改，只对部分功能做了增强，例如<code>SelectedSelectionKeySetSelector#select</code></li></ol><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">final</span> <span class="token keyword">class</span> <span class="token class-name">SelectedSelectionKeySetSelector</span> <span class="token keyword">extends</span> <span class="token class-name">Selector</span> <span class="token punctuation">{</span>

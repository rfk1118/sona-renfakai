import{_ as e,V as p,W as t,Y as n,a1 as s,Z as o,a0 as c,F as l}from"./framework-e54e0297.js";const i={},u=c(`<h1 id="策略-享元" tabindex="-1"><a class="header-anchor" href="#策略-享元" aria-hidden="true">#</a> 策略+享元</h1><h2 id="问题" tabindex="-1"><a class="header-anchor" href="#问题" aria-hidden="true">#</a> 问题</h2><p>本章使用 Spring 的容器管理 Service，在处理业务时候根据映射进行转换，从 ApplicationContext 中获取到策略，极大减少了手动编写代码管理 Bean 的问题。 来看一下目录:</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token punctuation">.</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h2><p>优点: 不需要编写额外的代码对 <code>Bean</code> 进行保存，使用的时候按照规约从 <code>ApplicationContext</code> 获取。 缺点: 使用 <code>BeanName</code> 获取 <code>Bean</code> 的时候需要进行强转，不如自己编写容器获取看起来更加优雅。 需要在测试阶段测试出 <code>BeanName-helloFourPolicyServiceImpl(HELLO(&quot;hello&quot;, &quot;helloFourPolicyServiceImpl&quot;))</code>是否正确。</p><p>提示: 如果在创表初期，可以直接将 <code>ServiceImpl</code> 名称存到数据库，如果业务已经开展，多方使用，字断不可更改，而且不想增加字断的话，需要在代码中增加映射，请大家酌情处理。</p>`,17),r={id:"github-地址",tabindex:"-1"},k=n("a",{class:"header-anchor",href:"#github-地址","aria-hidden":"true"},"#",-1),d={href:"https://github.com/sona0402/Polymorphism",target:"_blank",rel:"noopener noreferrer"};function v(m,b){const a=l("ExternalLinkIcon");return p(),t("div",null,[u,n("h2",r,[k,s(),n("a",d,[s("Github 地址"),o(a)])])])}const g=e(i,[["render",v],["__file","spring-fly-weight.html.vue"]]);export{g as default};

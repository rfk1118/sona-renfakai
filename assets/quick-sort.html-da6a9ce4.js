import{_ as l,V as d,W as t,Y as n,a1 as i,Z as a,a0 as e,F as c}from"./framework-e54e0297.js";const r={},u=e('<h1 id="快速排序" tabindex="-1"><a class="header-anchor" href="#快速排序" aria-hidden="true">#</a> 快速排序</h1><h2 id="划分" tabindex="-1"><a class="header-anchor" href="#划分" aria-hidden="true">#</a> 划分</h2><div class="hint-container tip"><p class="hint-container-title">提示</p><p>划分是快排的核心</p></div><p>划分算法使用双指针进行工作，初始时两个指针分别指向数组的两头（这里的指针其实是数组的角标，而不是引用），在左边的指针，向右移动，而右边的指针向左移动。 当<code>leftPtr</code>遇到比枢纽小的数据项时候，向右移动，因为这个数据已经在正确的位置了，当<code>rightPtr</code>遇到比枢纽大的数据项时候，向左移动，因为这个数据也已经在正确位置了。如果<code>leftPtr</code>大于了<code>rightPtr</code>说明已经处理完毕了。</p><h2 id="标准快排" tabindex="-1"><a class="header-anchor" href="#标准快排" aria-hidden="true">#</a> 标准快排</h2>',5),o={href:"https://algs4.cs.princeton.edu/23quicksort/Quick.java.html",target:"_blank",rel:"noopener noreferrer"},v=n("li",null,"使用最后一个元素作为切割点的，例如《编程珠玑》",-1),m=e(`<div class="language-Go line-numbers-mode" data-ext="Go"><pre class="language-Go"><code>// QuickSort 标准快排，这里使用lo元素作为切割垫
